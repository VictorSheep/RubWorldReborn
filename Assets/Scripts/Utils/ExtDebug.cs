using UnityEngine;
 ...
 public static class ExtDebug
 {
     ...
     public static void DrawSphereCastBox(Vector3 center, float radius, Vector3 direction, float maxDistance, Color color)
     {
         DrawWireSphere(center, radius, color, 0);
         DrawWireSphere(center + maxDistance * direction, radius, color, 0);
     }
